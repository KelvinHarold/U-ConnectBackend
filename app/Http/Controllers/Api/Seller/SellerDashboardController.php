...
{
  // In SellerDashboardController.php

public function index()
{
    $sellerId = auth()->id();

    // Orders stats (no change needed)
    ...
    // CHANGE THIS: Recent Orders limited to 5 (was 10)
    ...
    // Monthly Sales (no change, this is aggregated data)
    ...
    // Top Products - already has take(5) ✓
    ...
    // Low stock alerts - already has take(5) ✓
